...
import com.jcedar.sdahyoruba.io.jsonhandlers.StudentChapterHandler;
...
import static com.jcedar.sdahyoruba.helper.AccountUtils.LoadProfileImage;
            ...
            loginBtn.registerCallback(new LoginButton.UserInfoChangedCallback() {
                ...
                public void onUserInfoFetched(GraphUser graphUser) {
                    if (graphUser != null) {
                       ...
                       *//* AppHelper.pullAndSaveAllHymnData();
